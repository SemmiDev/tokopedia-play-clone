...
async function createProduct(req, res) {
    try {
        ...
        if (!validation.valid) {
            return ErrorResponse({ res, statusCode: 400, message: 'Validation errors.', errors: validation.errors });
        }
...
export {createProduct, getAllProducts, getProductsByVideoId, getProductbyId, updateProduct, deleteProduct};
